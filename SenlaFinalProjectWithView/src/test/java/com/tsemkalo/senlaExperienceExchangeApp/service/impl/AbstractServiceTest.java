...
public abstract class AbstractServiceTest {
	...
	public void addLesson(Long id, String theme, String subject, User teacher, Course course, LessonStatus status, String address, Boolean individual, Integer maxStudentsNumber, String description, Integer cost, Integer duration, LocalDateTime lessonDate, Integer fixedSalary, Integer unfixedSalary, Double averageRating) {
		Lesson lesson = new Lesson(theme, subject, teacher, course, status, address, individual, maxStudentsNumber, description, cost, duration, lessonDate, fixedSalary, unfixedSalary, averageRating);
		lesson.setId(id);
