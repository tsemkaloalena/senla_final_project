...
public class LessonMapper implements Mapper<Lesson, LessonDto> {
	...
	public LessonDto toDto(Lesson lesson) {
		...
		return new LessonDto(lesson.getId(), lesson.getTheme(), lesson.getSubject(), teacherId, courseId, lesson.getStatus(), lesson.getAddress(), lesson.getIndividual(), lesson.getMaxStudentsNumber(), lesson.getDescription(), lesson.getCost(), lesson.getDuration(), lesson.getLessonDate(), lesson.getFixedSalary(), lesson.getUnfixedSalary(), lesson.getFreePlacesLeft(), lesson.getAverageRating());
	}
	...
	public Lesson toEntity(LessonDto dto) {
		...
		Lesson lesson = new Lesson(dto.getTheme(), dto.getSubject(), teacher, course, dto.getStatus(), dto.getAddress(), dto.getIndividual(), dto.getMaxStudentsNumber(), dto.getDescription(), dto.getCost(), dto.getDuration(), dto.getLessonDate(), dto.getFixedSalary(), dto.getUnfixedSalary(), dto.getAverageRating());
