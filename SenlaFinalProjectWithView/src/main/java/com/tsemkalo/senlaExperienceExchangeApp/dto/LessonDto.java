...
//	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "dd.MM.yyyy HH:mm")
	...
	public LessonDto(Long id, String theme, String subject, Long teacherId, Long courseId, LessonStatus status, String address, Boolean individual, Integer maxStudentsNumber, String description, Integer cost, Integer duration, LocalDateTime lessonDate, Integer fixedSalary, Integer unfixedSalary, Integer freePlacesLeft, Double averageRating) {
		this.id = id;
		this.theme = theme;
